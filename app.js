...
app.post('/api/message', function(req, res) {
    ...
    function callconversation(payload) {
     ...
     // if (queryInput == '{"text":"Arabic"}') {
     //      workspaceID = '8a5954cb-93d6-4736-b1d6-003a55bcec7f';
     //  }
     //  else if (queryInput == '{"text":"English"}') {
     //       workspaceID = '98b1e97f-5ed6-4446-8284-ebce8913013f';
     //   }
...
const queryInput = JSON.stringify(payload.input);
            ...
            const url =
            "https://v3.exchangerate-api.com/pair/856ed0030f940320a48ea68e/"+ c+"/"+b;
